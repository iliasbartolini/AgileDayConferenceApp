...
/**
 * Custom layout that contains and organizes a {@link TimeRulerView} and several instances of {@link BlockView}. 
...
public class BlocksLayout extends ViewGroup {
	...
	/**
	 * Remove any {@link BlockView} instances, leaving only {@link TimeRulerView} remaining.
	 */
